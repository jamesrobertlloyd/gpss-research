...
Surprisingly, each kernel in a product modifies the resulting model in a consistent way, resulting in a highly modular text generation algorithm.
...
As a simple example, a kernel of the form $\kSE \times \kPer \times  \kLin \times \boldsymbol{\sigma}$ could be described as:
\begin{align*}
...
\underbrace{\boldsymbol{\bar\sigma}}_{\small \textnormal{\small until 2100}}
\end{align*}
...
\begin{align*}
\kSE \times \kWN \times \kLin + \boldsymbol{\bar\sigma} \times\kSE \times \kC + \boldsymbol{\sigma} \times\kSE \times \kPer.
\end{align*}
which can be simplified to
\begin{align*}
\kWN \times \kLin + \kSE \times \boldsymbol{\bar\sigma} + \kSE \times \kPer \times \boldsymbol{\sigma}.
\end{align*}
...
%
The second component could be described as `A smooth function with a lengthscale of [lengthscale]', corresponding to the $\kSE$, 'which applies until [changepoint]', which corresponds to the $\boldsymbol{\bar\sigma}$.
%
