...
Rather than describing this multiplication literally its effect is described as \eg \genText{`lineary growing standard deviations'}.
Similarly, multiplication by $\kLin^n$ is described as \genText{`polynomially varying amplitude'}.
...
Products of sigmoids correspond to intervals (where their value is close to 1).
%, and their product is equivalent to taking the intersection of intervals.
Computing these intervals is straightforward, and can be simply described by \eg \genText{`this function applies from [start] until [end]'}.
