...
A sum of kernels corresponds to a sum of functions which allows each product of kernel to be described separately.
...
Ignoring the specific parameters of kernels, $\kSE$ is idempotent \ie $\kSE \times \kSE = \kSE$ (simply, the product of two $\kSE$ kernels is another $\kSE$ kernel but with different parameters).
