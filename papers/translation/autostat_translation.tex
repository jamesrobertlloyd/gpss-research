...
Sparse spectrum \gp{}s \citep{lazaro2010sparse} approximate the spectral density of a stationary kernel function using delta functions which corresponds to Bayesian linear regression using sinusoidal basis functions.
Similarly, \citet{WilAda13} introduce spectral mixture kernels which approximate the spectral density using a mixture of Gaussian distributions.
Both of these kernel classes are special cases of our language of kernels (see table~\ref{table:motifs}).
