...
\begin{frame}{Discovering a good model via search}
  \begin{itemize}
    ...
    \vspace{\baselineskip}
    \item The space spanned by this language is large and open-ended requiring a judicious search procedure
    \vspace{\baselineskip}
...
We can therefore describe each component in turn
