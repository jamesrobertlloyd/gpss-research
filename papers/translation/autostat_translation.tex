...
\begin{figure}[h]
\centering
\fbox{\includegraphics[trim=0cm 7.4cm 0cm 11.5cm, clip, width=0.98\columnwidth]{airlinepages/01-airline-separate-pages-2}}
\caption{
...
\begin{figure}[h]
\centering
\fbox{\includegraphics[trim=0cm 17cm 0cm 4.4cm, clip, width=0.98\columnwidth]{airlinepages/01-airline-separate-pages-3}}
%\caption{
%A caption.}
%\label{fig:exec}
\end{figure}
...
\begin{figure}[h]
\centering
\fbox{\includegraphics[trim=0cm 16.5cm 0cm 4cm, clip, width=0.98\columnwidth]{airlinepages/01-airline-separate-pages-4}}
%\caption{
%A caption.}
%\label{fig:exec}
\end{figure}
...
\begin{figure}[h]
\centering
\fbox{\includegraphics[trim=0cm 17cm 0cm 3.5cm, clip, width=0.98\columnwidth]{airlinepages/01-airline-separate-pages-6}}
%\caption{
%A caption.}
%\label{fig:exec}
\end{figure}
...
\NA{
Nothing really quite compares to this work in terms of translation; the closest would be equation learning and trend-periodicity-short-term models.
...
\NA{
Ideally would also compare to ARIMA - but this is a very different class of method - and a GPSS interpretation could be produced.
}
