...
\begin{frame}{Bayes rule applied to linear regression}
  ...
  Posterior is a normal dist: $m\,|\,y,x \sim \mathcal{N}\bigg(\frac{\sum_i x_i y_i}{\sum_i x_i^2 + \sigma_\varepsilon^2}, \frac{\sigma_\varepsilon^2}{\sum_i x_i^2 + \sigma_\varepsilon^2}\bigg)$
\end{frame}
