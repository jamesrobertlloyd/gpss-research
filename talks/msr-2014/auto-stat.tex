...
\begin{frame}{Automatic description of models}
  \begin{itemize}
    ...
    \vspace{\baselineskip}
    \item Models can be {\bf decomposed} into a sum products
    \begin{itemize}
...
%\hspace{-3.5mm}
%\begin{tabular}{c}
%\includegraphics[trim=30 0 62 25, clip, width=0.18\textwidth]{figures/03-mauna2003_all} \hspace{-3mm} \\
% entire signal
%\end{tabular}
%}
%\begin{tabular}{cccccc}
%\\
% & \includegraphics[trim=30 0 62 25, clip, width=0.18\textwidth]{figures/03-mauna2003_1} & \raisebox{0.5cm}{$+$} & \includegraphics[trim=30 0 62 25, %clip, width=0.18\textwidth]{figures/03-mauna2003_2} & \raisebox{0.5cm}{$+$} \\
%& $\kSE \times \kLin$ & & $\kSE \times \kPer$ \\
%\raisebox{-0cm}{$=$} & smooth trend & + & periodicity & +\\ \\
%& \includegraphics[trim=30 0 62 25, clip, width=0.18\textwidth]{figures/03-mauna2003_3} \\
%& $\kSE$ \\
...
\begin{frame}{Example: Sulphuric acid production}
  See pdf
\end{frame}
