...
These automatically-constructed models were demonstrated to be interpretable, but this was performed post-hoc by the authors.
...
\TBD{Turn this into an algorithm - use the text from the workshop paper}
...
\TBD{Not worthy of main body - try to make small}
...
\TBD{This can be significantly shortened - do not need model checking yet}
...
\TBD{Look at workshop paper for changes to language}
