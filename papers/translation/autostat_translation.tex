...
We also\fTBD{RG: Try to tie these things together} expand and improve the components used in the model-construction process to improve the expressivity and interpretability of the models.
...
\TBD{Please beautify and integrate this material into the previous section as you see fit. Potentially reordering with translation section?}
...
The removal of constants results in base kernels which are atomic from the point of view of translation\fTBD{In the way they are currently translated at least} and they make anti-correlation less likely\fTBD{however, they are not orthogonal in any sense so anti-correlation can still happen - I'm not sure how to avoid this or whether it is inevitable}.
...
\section{Second attempt at translation section}

\TBD{Written in note form at the moment}
...
Each of these separate translation tasks is now small enough that sentences can be templated based on parameter values and basic properties of the posterior.
...
\subsection{Translation is modular}
...
\subsection{Translation of changepoints}
...
\subsection{Translation of linear}
...
\subsection{Translation of stationary}
...
\section{Worked example of translation}
...
The first component is the constant base kernel - its translation can be looked up.
...
The constant base kernel is then described separately by looking up its translation.
