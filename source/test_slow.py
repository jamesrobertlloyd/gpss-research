...
class experiment_testcase(unittest.TestCase):
    ...
    def test_experiment_and_writeup(self):
        ...
        postprocessing.make_all_1d_figures(['../results/debug-changepoint/'], '../analyses/debug-changepoint/figures/', rescale=False, data_folder='../data/debug/', skip_kernel_evaluation=True)
