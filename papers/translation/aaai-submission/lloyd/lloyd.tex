...
/Author (James Robert Lloyd, David Duvenaud, Roger Grosse, Joshua B. Tenenbaum, Zoubin Ghahramani)
}
...
\usepackage{natbib, xcolor, wrapfig, booktabs, multirow}
...
\fbox{\includegraphics[width=0.98\columnwidth]{figure-01.pdf}}
\caption{
...
\includegraphics[width=0.98\columnwidth]{figure-02.pdf}
\caption{
...
\fbox{\includegraphics[width=0.98\columnwidth]{figure-03.pdf}}
\caption{
...
\fbox{\includegraphics[width=0.98\columnwidth]{figure-04.pdf}}
...
\fbox{\includegraphics[width=0.98\columnwidth]{figure-05.pdf}}
...
\includegraphics[width=0.98\columnwidth]{figure-06.pdf}
\caption{
...
\fbox{\includegraphics[width=0.98\columnwidth]{figure-07.pdf}}
\caption{
...
\fbox{\includegraphics[width=0.98\columnwidth]{figure-08.pdf}}
...
\fbox{\includegraphics[width=0.98\columnwidth]{figure-09.pdf}}
...
\begin{tikzpicture}[]
  \begin{scope}[xshift=0.0\textwidth]
    \node [mybox] (box){
      \fbox{\includegraphics[width=0.35\columnwidth]{03-mauna2003-s_3.pdf}}
    };
  \end{scope}  
  ...
  \begin{scope}[xshift=0.5\columnwidth]
    ...
    \node [mybox] (box){
      \fbox{\includegraphics[width=0.35\columnwidth]{03-mauna_3.pdf}}
    };
    \end{scope}
    \node[font=\LARGE] at (0,0) {$+$};
    \begin{scope}[yshift=-0.15\columnwidth]
    \node [mybox] (box){
      \fbox{\includegraphics[width=0.35\columnwidth]{03-mauna_5.pdf}}
    };
    \end{scope}
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}[]
  \begin{scope}[xshift=0.0\textwidth]
    \begin{scope}[yshift=+0.15\columnwidth]
    \node [mybox] (box){
      \fbox{\includegraphics[width=0.35\columnwidth]{01-airline-months_1.pdf}}
    };
    \end{scope}
    \node[font=\LARGE] at (0,0) {$+$};
    \begin{scope}[yshift=-0.15\columnwidth]
    \node [mybox] (box){
      \fbox{\includegraphics[width=0.35\columnwidth]{01-airline-months_2.pdf}}
    };
    \end{scope}
  \end{scope}  
  \begin{scope}[xshift=0.25\columnwidth]
  ...
  \begin{scope}[xshift=0.5\columnwidth]
    \begin{scope}[yshift=+0.15\columnwidth]
    \node [mybox] (box){
      \fbox{\includegraphics[trim=0cm 0cm 0cm 0cm, clip, width=0.35\columnwidth]{01-airline_1.pdf}}
    };
    \end{scope}
    \node[font=\LARGE] at (0,0) {$+$};
    \begin{scope}[yshift=-0.15\columnwidth]
    \node [mybox] (box){
      \fbox{\includegraphics[trim=0cm 0cm 0cm 0cm, clip, width=0.35\columnwidth]{01-airline_2.pdf}}
    };
    \end{scope}
  \end{scope}
\end{tikzpicture}
...
\begin{figure*}[ht]
\centering
\includegraphics[width=\textwidth]{box_extrap_wide.pdf}
\caption{
...
This work was funded in part by NSERC and Google.
