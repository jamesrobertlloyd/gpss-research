...
def read_outputs(write_file):
    ...
    npll = gpml_result['npll'][0,0]
    mae = gpml_result['mae'][0,0]
    std_ratio = gpml_result['std_ratio'][0,0]
    ...
    return OptimizerOutput(kernel_hypers, nll, npll, nlls, mae, std_ratio, hessian, noise_hyp)
