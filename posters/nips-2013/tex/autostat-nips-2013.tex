...
\newcommand{\airlinefigtwo}[1]{\includegraphics[trim=30 0 62 25, clip, width=0.21\columnwidth]{../figures/01-airline-months_#1}}
...
\\%[1cm]
\uptext{$=$}
\airlinefigtwo{1} & \uptext{$+$} \airlinefigtwo{2} & \uptext{$+$} \airlinefigtwo{3} \\
 $\kSE \times \kLin$ & $\kSE \times \kLin \times \kPer$ & $\kSE \times \kLin$ \\
smooth trend \quad + & growing periodic \quad + &  short-term deviation
\end{tabular}
\end{tabular}
