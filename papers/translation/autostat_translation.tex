...
We demonstrate the ability of our procedure to describe a variety of patterns on two time series (full automatically produced reports for a greater number of data sets are in supplementary material).
Since it is difficult to quantify the quality of a verbal description, we also provide numerical evidence in support of our procedure in section~\ref{sec:numerical}.
