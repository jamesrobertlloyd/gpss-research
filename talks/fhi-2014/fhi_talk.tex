...
Previous work introduced idea of grammar of compositions:
	\begin{itemize}
		...
		\\
		Roger Grosse, Ruslan Salakhutdinov, \\William T. Freeman, Joshua Tenenbaum
		\item Similar (and earlier) work on unsupervised learning
...
\begin{center}
	\includegraphics[width=1\textwidth]{matrix_figures/fig1}
\end{center}
