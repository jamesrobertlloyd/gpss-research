...
We also reparametrise the base kernels resulting in clearer decompositions and descriptions of the models produced.  We call the new procedure Automatic Bayesian Covariance Discovery (\procedurename). \fTBD{DD:  or maybe GP structure discovery - GPSD?}
