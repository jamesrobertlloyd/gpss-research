...
\begin{itemize}
  ...
  \item The kernel specifies which structures are likely under the GP prior \\ - which determines the generalization properties of the model.
...
\begin{itemize}
    ...
    \item Building composite kernels previously required human expertise
\end{itemize}
...
\mysection{We can build models by  greedy search}
