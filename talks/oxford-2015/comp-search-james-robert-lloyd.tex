...
\title{Exploratory model construction in compositional spaces and the automatic statistician project}
...
\begin{frame}{Agenda}
  \begin{itemize}
    \item Two systems for exploratory model construction
    \vspace{\baselineskip}
    \item Matrix factorisation
    \begin{itemize}
      \item Work by Roger Grosse et alia
      \item Inspiration for later work on\dots
    \end{itemize}
    \vspace{\baselineskip}
    \item Regression using Gaussian processes
    \begin{itemize}
      \item Structure of models allows for easy translation into natural language descriptions
    \end{itemize}
  \end{itemize}
\end{frame}

\begin{frame}{Many probabilistic models for matrices}
  \begin{center}
	  \includegraphics[width=1.0\textwidth]{../figures/matrix_figures/many_models}
  \end{center}
  \begin{itemize}
    \item Which one should we use and when?
    \item When do we need to invent new models?
  \end{itemize}
\end{frame}

\begin{frame}{Matrix decomposition - e.g.\ clustering}
  \begin{center}
	  \includegraphics[width=0.8\textwidth]{../figures/matrix_figures/input}
  \end{center}
\end{frame}

\begin{frame}{Recursive matrix decomposition}
  \begin{center}
	  \includegraphics[width=\textwidth]{../figures/matrix_figures/fig1}
  \end{center}
  \begin{itemize}
...
\begin{frame}{Building blocks of a modelling language}
  \begin{center}
	  \includegraphics[width=\textwidth]{../figures/matrix_figures/buildingblocks}
  \end{center}
\end{frame}

\begin{frame}{Grammar of the language}
  \begin{center}
	  \includegraphics[width=\textwidth]{../figures/matrix_figures/grammar}
  \end{center}
\end{frame}

\begin{frame}{A language of models}
  \begin{center}
	  \includegraphics[width=1.0\textwidth]{../figures/matrix_figures/modeltree}
  \end{center}
\end{frame}

\begin{frame}{Evolution of image models}
  \begin{center}
	  \includegraphics[width=\textwidth]{../figures/matrix_figures/cartoon}
  \end{center}
\end{frame}

\begin{frame}{Application to Natural Image Patches}
  \begin{center}
	  \includegraphics[width=\textwidth]{../figures/matrix_figures/images}
  \end{center}
\end{frame}

\begin{frame}{Can we do the same for regression?}
  \begin{itemize}
    \pause
    \item Yes
    \vspace{\baselineskip}
    \pause
    \item Initial results suggested that learned models were often quite interpretable
    \vspace{\baselineskip}
    \pause
    \item With a careful choice of modelling language it is trivial to produce natural language descriptions of data
  \end{itemize}
\end{frame}
...
regression & \\
Polynomial regression & $\kC + \sum_d \prod \kLin_d + \kWN$ \\
...
\begin{frame}{What next?}
 \begin{itemize}
   ...
   \end{itemize}
   \vspace{\baselineskip}
   \item Currently researching methods for rational use of computational resources\dots
 \end{itemize}
\end{frame}
