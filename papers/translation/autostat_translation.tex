...
We include learned equations for these two data sets produced using Eureqa (cite).
...
The variability of the results also suggests there is room to improve the robustness of GPSS.
...
We compare the structure search algorithm to equation learning \cite{Schmidt2009b} and four other regression algorithms; additive nonparametric (cite), change point modelling (cite) / multi resolution Gaussian processes (cite), spectral kernels (cite) and trend-cyclical-irregular (cite).
