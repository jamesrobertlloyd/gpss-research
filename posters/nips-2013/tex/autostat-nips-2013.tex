...
\begin{itemize}
\item Search can produce arbitrarily complex kernels
\item How to automatically describe such models?
\item To do this, we:
\begin{itemize}
\item Break each kernel into a sum of product
\item Look up the properties of each kernel in the product
\item Combine their pro
\end{itemize}
\end{itemize}
...
\vspace{3\baselineskip}
 ...
 {\bf Each kernel in a product corresponds to an adjective}
...
\raggedright
Code available at \url{github.com/jamesrobertlloyd/gpss-research}
