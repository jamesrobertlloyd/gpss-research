...
class experiment_testcase(unittest.TestCase):
    ...
    def test_experiment_and_writeup_cp(self):
        experiment_old.run_experiment_file('../experiments/debug/debug_changepoint.py')
    ...
    def test_experiment_and_writeup_cw(self):
        experiment_old.run_experiment_file('../experiments/debug/debug_changewindow.py')
    ...
    def test_experiment_and_writeup(self):
        experiment_old.run_debug_kfold()
