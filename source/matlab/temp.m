load '/tmp/tmpP868UU.mat'  % Load the data, it should contain X and y.
X = double(X);
y = double(y);
...
noise = [-inf];
figname = '/scratch/home/Research/GPs/gpss-research/analyses/2013-10-01-pure-lin/figures/01-airline/01-airline';
